...
function App(props) {
  ...
  // todo: move this out of app.jsx with a custom hook
  ...
  // todo: Read your Juke balance like, need address :)
  // const jukeBalance = useContractReader(
  //   mainnetContracts,
  //   "Juke",
  //   "balanceOf",
  //   [""],
  ...
  // const addressFromENS = useResolveName(mainnetProvider, "jaxcoder.eth");
  // console.log("🏷 Resolved jaxcoder.eth as:", addressFromENS);

  // todo: move this out of this file with a custom hook
